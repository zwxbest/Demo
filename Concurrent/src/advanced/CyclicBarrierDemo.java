...
public class CyclicBarrierDemo {
    ...
    public static class Soldoer implements Runnable{

        private String soldier;
        private final CyclicBarrier cyclicBarrier;

        Soldoer(CyclicBarrier cyclicBarrier,String soldierName)
        {
...
//        final int N=50; //如果已经中间已经有interrupt，那这个cyclicBarrier的第一轮不管后面有多少线程加入await，都会报broke异常，
        ...
        for(int i=0;i<N;i++)
        {
            ...
            allSoldier[i]=new Thread(new Soldoer(cyclicBarrier,"士兵"+i));
